...
(() => {
  ...
  const SONGS = [
    { name: "荒城の月", title: "聞き役", rank: "06", min: 0, sky: "waxing", bg: "kojo", notes: [69, 69, 74, 76, 77, 76, 74, 70, 70, 69, 68, 69, 69, 69, 74, 76, 77, 76, 74, 70, 67, 69, 69, 62, 65, 65, 64, 62, 70, 70, 69, 67, 69, 70, 70, 69, 69, 69, 74, 76, 77, 76, 74, 70, 67, 69, 69, 62] },   // 滝廉太郎 1901（原曲・ロ短調をニ短調へ移調）。「はなのえん」の「え」は原曲どおり第4音を半音上げた音（G♯）＝山田耕筰版はここを下げている。月が透明から浮かび上がる
